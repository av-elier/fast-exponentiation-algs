#include "algorithms/kamenevs/YakobiVector.h"
#include <algorithm>

vector<string>* YakobiVector::create_str_dicitionary(string s)
{
...
vector<ZZ>* YakobiVector::create_num_dicitionary(vector<string>& strs)
{
